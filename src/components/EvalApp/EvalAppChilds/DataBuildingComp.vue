    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-wrap justify-center gap-5 mx-10 mb-10">
           ...
           <div
            ...
            <!-- L'id dataBuildingBtn sert à retrouver le bon chemin lors d'un previous step vers data building -->
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-col lg:flex-row lg:justify-between justify-center lg:w-4/5">
                <ButtonPreviousStep v-on:click="selectBuildingType('BuildingTypeComp'), scrollToTop()" />
                <ButtonNextStep id="dataBuildingBtn" v-on:click="selectAmenities('AmenitiesComp'), scrollToTop()"
                />
            </div>
        </div>
...
export default {
    name: "DataBuildingComp",

    data() {
        return {
            title: "Données de votre appartement",
            txt: "Complétez les données de votre bien immobilier",
            titleCard: ["Surface habitable : ", "Année de construction : ", "Nombre de pièces : ",
    ...
    methods: {
        ...
        selectBuildingType(selectedComponent) {
            this.$emit("change-component", selectedComponent);
        },
