<template>
    <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-wrap justify-center gap-5 mx-10 mb-10">
            ...
            <button 
                v-on:click="selectHouseType(homeTypeChoice[0][0], 'DataHouseComp')"
                @mousedown="isHoveredIndividual = true"
                ...
                <p class="font-bold text-base text-sky-950">Individuelle</p>
                <div class="font-semibold flex text-sm text-sky-100 bg-sky-950 py-2 px-4 border-none rounded hover:bg-orange-500 duration-100">
                    ...
                    <fa class="iconBtn text-xl ml-4" :icon="isHoveredIndividual ? 'check-circle' : 'circle-right'" />
                </div>
            </button>


            <button 
                v-on:click="selectHouseType(homeTypeChoice[0][1], 'DataHouseComp')"
                @mousedown="isHoveredJumelee = true"
                class="relative flex flex-col justify-around items-center rounded w-[180px] h-[280px] bg-sky-100 
                shadow-[0px_4px_20px_rgba(0,0,0,0.66)] transform duration-200 hover:shadow-[0px_4px_20px_rgba(255,255,255,0.33)]
                ...
                onmouseout="this.querySelector('.text-sky-950').style.color = ''; this.querySelector('.bg-sky-950').style.backgroundColor = ''; this.querySelector('p').style.color = '';">
                <fa class="text-sky-950 text-7xl" icon="house-chimney" />
                <p class="font-bold text-base text-sky-950">Jumelée</p>
                <div class="font-semibold flex text-sm text-sky-100 bg-sky-950 py-2 px-4 border-none rounded hover:bg-orange-500 duration-100">
                    <span class="flex items-center">Sélectionner</span>
                    <fa class="iconBtn text-xl ml-4" :icon="isHoveredJumelee ? 'check-circle' : 'circle-right'" />
                </div>
            </button>


            <button 
                v-on:click="selectHouseType(homeTypeChoice[0][2], 'DataHouseComp')"
                @mousedown="isHoveredContigue = true"
                class="relative flex flex-col justify-around items-center rounded w-[180px] h-[280px] bg-sky-100 
                shadow-[0px_4px_20px_rgba(0,0,0,0.66)] transform duration-200 hover:shadow-[0px_4px_20px_rgba(255,255,255,0.33)]
                ...
                onmouseout="this.querySelector('.text-sky-950').style.color = ''; this.querySelector('.bg-sky-950').style.backgroundColor = ''; this.querySelector('p').style.color = '';">
                <fa class="text-sky-950 text-7xl" icon="house-chimney" />
                <p class="font-bold text-base text-sky-950">Contiguë</p>
                <div class="font-semibold flex text-sm text-sky-100 bg-sky-950 py-2 px-4 border-none rounded hover:bg-orange-500 duration-100">
                    <span class="flex items-center">Sélectionner</span>
                    <fa class="iconBtn text-xl ml-4" :icon="isHoveredContigue ? 'check-circle' : 'circle-right'" />
                </div>
            </button>

            <button 
                v-on:click="selectHouseType(homeTypeChoice[0][3], 'DataHouseComp')"
                @mousedown="isHoveredContiguePignon = true"
                class="relative flex flex-col justify-around items-center rounded w-[180px] h-[280px] bg-sky-100 
                shadow-[0px_4px_20px_rgba(0,0,0,0.66)] transform duration-200 hover:shadow-[0px_4px_20px_rgba(255,255,255,0.33)]
                ...
                onmouseout="this.querySelector('.text-sky-950').style.color = ''; this.querySelector('.bg-sky-950').style.backgroundColor = ''; this.querySelector('p').style.color = '';">
                <fa class="text-sky-950 text-7xl" icon="house-chimney" />
                <p class="font-bold text-base text-sky-950">Contiguë en pignon</p>
                <div class="font-semibold flex text-sm text-sky-100 bg-sky-950 py-2 px-4 border-none rounded hover:bg-orange-500 duration-100">
                    <span class="flex items-center">Sélectionner</span>
                    <fa class="iconBtn text-xl ml-4" :icon="isHoveredContiguePignon ? 'check-circle' : 'circle-right'" />
                </div>
            </button>

            <button 
                v-on:click="selectHouseType(homeTypeChoice[0][4], 'DataHouseComp')"
...
export default {
    ...
    data() {
        return {
            ...
            isHoveredIndividual: false,
            isHoveredJumelee: false,
            isHoveredContigue: false,
            isHoveredContiguePignon: false,
    ...
    methods: {
        selectHouseType(choice, selectedComponent) {
            setTimeout(() => {
                
            this.$emit("home-type-selected", choice);

            const comparTable = this.homeTypeChoice[0];

            for (const valeur of comparTable) {
                if (choice === valeur) {
                    this.$emit("update-title", "Données de votre maison");
                    break;
                }
            }
